...
function Hero() {
  ...
  return (
    <section id="#section--1" className="px-2">
        <div className={`flex flex-row justify-around py-20 ${responsive === true ? 'flex-col items-start gap-10' : 'flex-row'} `}>
        <h1 className="font-bebas text-[4rem] leading-[3.5rem]">ABOUT ME</h1>
        <div className="flex flex-col gap-5 w-[350px]">
            <h2>I am a front-end developer based in Sydney. Has Mechanical Engineering background. </h2>
            <p className="text-xs text-[var(--light-gray)]">I am a front-end developer based in Sydney looking for exciting opportunities. Has Mechanical Engineering background. Likes to focus on accessibility when developing. Passionate and curious about solving problems. Currently, I’m exploring Reactjs, Webflow and a bit of Designing. While I am not programming, I enjoy playing football, photography and playing Valorant. Learning more to improve skill</p>
            <div className="flex justify-around items-center w-[350px]">
                ...
                >
                    ...
                    <svg width="54" height="54" viewBox="0 0 54 54" style={{cursor:'pointer'}} fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <img src={image2} className="w-[40%] rounded-xl mx-auto" alt="" />
        <img src={image1} className="w-[40%] rounded-xl mx-auto" alt="" />
        </div>
    </section>
  )
}
